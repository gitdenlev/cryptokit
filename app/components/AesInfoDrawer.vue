      ...
      >
        <div>
          <p class="text-[15px] text-(--ck-muted) leading-relaxed">
            ...
            confidentiality and integrity. It's the gold standard for symmetric
            encryption.
          </p>
        </div>
        ...
        <div>
          ...
          <ul
            class="list-disc flex flex-col gap-4 text-[14px] text-(--ck-muted) ml-2.5 pl-5"
          >
            <li>
        ...
        <div>
          ...
          <div class="flex flex-col gap-3">
            ...
            >
              ...
              <p class="text-[13px] text-(--ck-muted) leading-relaxed">
        ...
        <div>
          ...
          >
            ...
            <li>
              Store the full ciphertext (IV + ciphertext), it's self-contained.
            </li>
